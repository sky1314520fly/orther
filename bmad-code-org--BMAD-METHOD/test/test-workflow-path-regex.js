...
// Test data
// ---------------------------------------------------------------------------
const sourcePath = '{project-root}/_bmad/bmm/workflows/ship/bmad-create-story/workflow.md';
...
assert(
  sourceMatch && sourceMatch[2] === 'ship/bmad-create-story/workflow.md',
  'Source regex group [2] is the workflow sub-path',
  `Expected "ship/bmad-create-story/workflow.md", got "${sourceMatch && sourceMatch[2]}"`,
);
