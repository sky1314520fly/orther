---
title: Tables
description: Create, query, and manage workspace tables from Chat.
---

import { Image } from '@/components/ui/image'
import { FAQ } from '@/components/ui/faq'

<Image src="/static/mothership/table-example.png" alt="Chat resource panel showing the pipeline_deals table with company, deal_owner, stage, and amount columns, alongside a chat summary of total pipeline value and breakdown by stage" width={900} height={487} />
...
<FAQ items={[
  { question: "Can Sim join or combine data from multiple tables?", answer: "Yes. Describe the relationship and what you want — Sim will query both tables and combine the results." },
  { question: "Is there a row limit?", answer: "There is no hard row limit set by Sim. Performance for very large tables may vary." },
  { question: "Can I use a table created in Chat as a workflow data source?", answer: "Yes. All workspace tables are accessible to the Table block in any workflow." },
]} />
