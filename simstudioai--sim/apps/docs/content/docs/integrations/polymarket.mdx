...
| Parameter | Type | Required | Description |
| --------- | ---- | -------- | ----------- |
| `marketId` | string | No | The numeric market ID \(e.g., "253591"\). Required if slug is not provided. Not the condition ID. |
...
| Parameter | Type | Required | Description |
| --------- | ---- | -------- | ----------- |
| `eventId` | string | No | The numeric event ID \(e.g., "12345"\). Required if slug is not provided. |
...
| `limit` | string | No | Maximum number of results per type \(events, tags, profiles\). Default: 50. |
...
| Parameter | Type | Required | Description |
| --------- | ---- | -------- | ----------- |
| `seriesId` | string | Yes | The numeric series ID \(e.g., "12345"\). |
...
| `type` | string | No | Activity type filter: TRADE, SPLIT, MERGE, REDEEM, REWARD, CONVERSION, MAKER_REBATE, REFERRAL_REWARD |
