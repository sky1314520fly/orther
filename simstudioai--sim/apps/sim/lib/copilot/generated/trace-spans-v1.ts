...
export const TraceSpan = {
  ...
  ChatAsyncSubagentRun: 'chat.async_subagent.run',
  ChatAsyncSubagentShutdown: 'chat.async_subagent.shutdown',
  ChatAsyncSubagentSpawn: 'chat.async_subagent.spawn',
  ...
  ChatOrchestrateInterrupt: 'chat.orchestrate.interrupt',
  ChatOrchestrateSteer: 'chat.orchestrate.steer',
  ChatOrchestrateTail: 'chat.orchestrate.tail',
  ChatOrchestrateWait: 'chat.orchestrate.wait',
  ...
  CopilotChatSteerStream: 'copilot.chat.steer_stream',
  ...
  CopilotToolsExecuteInband: 'copilot.tools.execute_inband',
  ...
  SimExecuteTool: 'sim.execute_tool',
...
export const TraceSpanValues: readonly TraceSpanValue[] = [
  ...
  'auth.validate_key',
  'chat.async_subagent.run',
  'chat.async_subagent.shutdown',
  'chat.async_subagent.spawn',
  ...
  'chat.orchestrate.steer',
  'chat.orchestrate.tail',
  'chat.orchestrate.wait',
