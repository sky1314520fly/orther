...
export const TraceAttr = {
  ...
  BillingLongContext: 'billing.long_context',
  ...
  ContextReduceBudgetSource: 'context.reduce.budget_source',
  ...
  CopilotAsyncSubagentAgent: 'copilot.async_subagent.agent',
  CopilotAsyncSubagentCount: 'copilot.async_subagent.count',
  CopilotAsyncSubagentDeltaChars: 'copilot.async_subagent.delta_chars',
  CopilotAsyncSubagentId: 'copilot.async_subagent.id',
  CopilotAsyncSubagentReminders: 'copilot.async_subagent.reminders',
  CopilotAsyncSubagentSleptMs: 'copilot.async_subagent.slept_ms',
  CopilotAsyncSubagentStatus: 'copilot.async_subagent.status',
  CopilotAsyncSubagentWaitMode: 'copilot.async_subagent.wait_mode',
  CopilotAsyncSubagentWakeReason: 'copilot.async_subagent.wake_reason',
  ...
  CopilotAsyncToolPermissionDecision: 'copilot.async_tool.permission_decision',
  ...
  CopilotSteerOutcome: 'copilot.steer.outcome',
  CopilotSteeringContentChars: 'copilot.steering.content_chars',
  CopilotSteeringEntries: 'copilot.steering.entries',
  CopilotSteeringMode: 'copilot.steering.mode',
  CopilotSteeringSalvagedChars: 'copilot.steering.salvaged_chars',
  ...
  LoopName: 'loop.name',
  ManageKnowledgeBaseId: 'manage_knowledge_base.id',
  ManageKnowledgeBaseName: 'manage_knowledge_base.name',
  ...
  PromptRegionFilesChars: 'prompt.region.files_chars',
  PromptRegionFilesCount: 'prompt.region.files_count',
  PromptRegionHistoryChars: 'prompt.region.history_chars',
  PromptRegionHistoryMessages: 'prompt.region.history_messages',
  PromptRegionRuntimeTailChars: 'prompt.region.runtime_tail_chars',
  PromptRegionSteeringChars: 'prompt.region.steering_chars',
  PromptRegionToolResultsChars: 'prompt.region.tool_results_chars',
  PromptRegionVfsChars: 'prompt.region.vfs_chars',
  PromptRegionVfsMessages: 'prompt.region.vfs_messages',
  PromptRuntimeActiveSkillsChars: 'prompt.runtime.active_skills_chars',
  PromptRuntimeTaggedResourcesChars: 'prompt.runtime.tagged_resources_chars',
  PromptSectionAgentGuidanceChars: 'prompt.section.agent_guidance_chars',
  PromptSectionCapabilitiesChars: 'prompt.section.capabilities_chars',
  PromptSectionCredentialsChars: 'prompt.section.credentials_chars',
  PromptSectionOverrideChars: 'prompt.section.override_chars',
  PromptSectionPersonaChars: 'prompt.section.persona_chars',
  PromptSectionPoliciesChars: 'prompt.section.policies_chars',
  PromptSectionSkillsIndexChars: 'prompt.section.skills_index_chars',
  PromptSectionSpawnContextChars: 'prompt.section.spawn_context_chars',
  PromptSectionSubagentDocsChars: 'prompt.section.subagent_docs_chars',
  PromptSectionToolDocsChars: 'prompt.section.tool_docs_chars',
  PromptSectionWorkspaceGuideChars: 'prompt.section.workspace_guide_chars',
  PromptSectionWorkspaceInventoryChars: 'prompt.section.workspace_inventory_chars',
  PromptSet: 'prompt.set',
  PromptSite: 'prompt.site',
  PromptSystemBlocks: 'prompt.system_blocks',
  PromptSystemChars: 'prompt.system_chars',
  PromptToolsWireChars: 'prompt.tools.wire_chars',
  PromptToolsWireCount: 'prompt.tools.wire_count',
...
export const TraceAttrValues: readonly TraceAttrValue[] = [
  ...
  'copilot.async_subagent.agent',
  'copilot.async_subagent.count',
  'copilot.async_subagent.delta_chars',
  'copilot.async_subagent.id',
  'copilot.async_subagent.reminders',
  'copilot.async_subagent.slept_ms',
  'copilot.async_subagent.status',
  'copilot.async_subagent.wait_mode',
  'copilot.async_subagent.wake_reason',
  'copilot.async_tool.claimed_by',
  'copilot.async_tool.has_error',
  'copilot.async_tool.ids_count',
  'copilot.async_tool.permission_decision',
  ...
  'copilot.steer.outcome',
  'copilot.steering.content_chars',
  'copilot.steering.entries',
  'copilot.steering.mode',
  'copilot.steering.salvaged_chars',
  ...
  'loop.iterations',
  'loop.name',
  'manage_knowledge_base.id',
  'manage_knowledge_base.name',
  ...
  'prompt.component',
  'prompt.region.files_chars',
  'prompt.region.files_count',
  'prompt.region.history_chars',
  'prompt.region.history_messages',
  'prompt.region.runtime_tail_chars',
  'prompt.region.steering_chars',
  'prompt.region.tool_results_chars',
  'prompt.region.vfs_chars',
  'prompt.region.vfs_messages',
  'prompt.runtime.active_skills_chars',
  'prompt.runtime.tagged_resources_chars',
  'prompt.section.agent_guidance_chars',
  'prompt.section.capabilities_chars',
  'prompt.section.credentials_chars',
  'prompt.section.override_chars',
  'prompt.section.persona_chars',
  'prompt.section.policies_chars',
  'prompt.section.skills_index_chars',
  'prompt.section.spawn_context_chars',
  'prompt.section.subagent_docs_chars',
  'prompt.section.tool_docs_chars',
  'prompt.section.workspace_guide_chars',
  'prompt.section.workspace_inventory_chars',
  'prompt.set',
  'prompt.site',
  'prompt.system_blocks',
  'prompt.system_chars',
  'prompt.tools.wire_chars',
  'prompt.tools.wire_count',
  'provider.id',
  'rate_limit.attempt',
  'rate_limit.count',
  'rate_limit.delay_ms',
