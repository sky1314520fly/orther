...
const DELIVERY = defineStripeKeyedSite(
  ...
  'the edit would be re-applied over any change made to the product in between, reverting the newer name or description buyers see'
)

export const stripeUpdateProductTool: ToolConfig<
  UpdateProductParams & StripeDeliveryContextParams,
  ProductResponse
> = {
