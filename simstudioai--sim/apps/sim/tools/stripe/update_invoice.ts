...
const DELIVERY = defineStripeKeyedSite(
  ...
  'the edit would be re-applied over any change made to the draft invoice in between, reverting the newer line items or due date'
)

export const stripeUpdateInvoiceTool: ToolConfig<
  UpdateInvoiceParams & StripeDeliveryContextParams,
  InvoiceResponse
> = {
