import type {
  SemrushDomainOrganicKeywordsParams,
  SemrushDomainOrganicKeywordsResponse,
  SemrushDomainOrganicKeywordsRow,
...
export const semrushDomainOrganicKeywordsTool: ToolConfig<
  SemrushDomainOrganicKeywordsParams,
  SemrushDomainOrganicKeywordsResponse
> = {
  id: 'semrush_domain_organic_keywords',
  name: 'Semrush Domain Organic Keywords',
  description:
  ...
  transformResponse: async (response: Response) => {
    const rows = await readSemrushReport<SemrushDomainOrganicKeywordsRow>(response, COLUMNS)
  ...
  outputs: {
    keywords: {
      type: 'array',
      description: 'Organic keywords the domain ranks for',
      items: {
        type: 'object',
        properties: {
          keyword: {
