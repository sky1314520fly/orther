import type {
  SemrushUrlPaidKeywordsParams,
  SemrushUrlPaidKeywordsResponse,
  SemrushUrlPaidKeywordsRow,
...
const COLUMNS = ['Ph', 'Po', 'Nq', 'Cp', 'Co', 'Tg', 'Tr', 'Tc', 'Nr', 'Td', 'Tt', 'Ds'] as const

export const semrushUrlPaidKeywordsTool: ToolConfig<
  SemrushUrlPaidKeywordsParams,
  SemrushUrlPaidKeywordsResponse
> = {
  id: 'semrush_url_paid_keywords',
  name: 'Semrush URL Paid Keywords',
  description:
  ...
  transformResponse: async (response: Response) => {
    const rows = await readSemrushReport<SemrushUrlPaidKeywordsRow>(response, COLUMNS)
  ...
  outputs: {
    keywords: {
      type: 'array',
      description: 'Paid keywords the URL is advertised on',
      items: {
        type: 'object',
        properties: {
          keyword: {
