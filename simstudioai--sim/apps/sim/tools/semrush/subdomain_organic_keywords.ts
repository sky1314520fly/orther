import type {
  SemrushSubdomainOrganicKeywordsParams,
  SemrushSubdomainOrganicKeywordsResponse,
  SemrushSubdomainOrganicKeywordsRow,
...
export const semrushSubdomainOrganicKeywordsTool: ToolConfig<
  SemrushSubdomainOrganicKeywordsParams,
  SemrushSubdomainOrganicKeywordsResponse
> = {
  id: 'semrush_subdomain_organic_keywords',
  name: 'Semrush Subdomain Organic Keywords',
  ...
  transformResponse: async (response: Response) => {
    const rows = await readSemrushReport<SemrushSubdomainOrganicKeywordsRow>(response, COLUMNS)
  ...
  outputs: {
    keywords: {
      type: 'array',
      description: 'Organic keywords the subdomain ranks for',
      items: {
        type: 'object',
        properties: {
          keyword: {
          ...
          trafficCost: {
            type: 'number',
            description: 'Share of the traffic cost of the target attributed to this keyword',
            optional: true,
            nullable: true,
          },
          competition: {
