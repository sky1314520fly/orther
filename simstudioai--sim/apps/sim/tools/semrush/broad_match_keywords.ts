import type {
  SemrushBroadMatchKeywordsParams,
  SemrushBroadMatchKeywordsResponse,
  SemrushBroadMatchKeywordsRow,
...
const COLUMNS = ['Ph', 'Nq', 'Cp', 'Co', 'Nr', 'Kd', 'Fk', 'In', 'Td'] as const

export const semrushBroadMatchKeywordsTool: ToolConfig<
  SemrushBroadMatchKeywordsParams,
  SemrushBroadMatchKeywordsResponse
> = {
  id: 'semrush_broad_match_keywords',
  name: 'Semrush Broad Match Keywords',
  description:
  ...
  transformResponse: async (response: Response) => {
    const rows = await readSemrushReport<SemrushBroadMatchKeywordsRow>(response, COLUMNS)
  ...
  outputs: {
    keywords: {
      type: 'array',
      description: 'Broad match keyword variations of the seed keyword',
      items: {
        type: 'object',
        properties: {
          keyword: {
