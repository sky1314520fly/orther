import type {
  SemrushUrlOverviewHistoryParams,
  SemrushUrlOverviewHistoryResponse,
  SemrushUrlOverviewHistoryRow,
...
export const semrushUrlOverviewHistoryTool: ToolConfig<
  SemrushUrlOverviewHistoryParams,
  SemrushUrlOverviewHistoryResponse
> = {
  id: 'semrush_url_overview_history',
  name: 'Semrush URL Overview History',
  ...
  transformResponse: async (response: Response) => {
    const rows = await readSemrushReport<SemrushUrlOverviewHistoryRow>(response, COLUMNS)
