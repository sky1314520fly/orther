import type {
  SemrushSubdomainOverviewHistoryParams,
  SemrushSubdomainOverviewHistoryResponse,
  SemrushSubdomainOverviewHistoryRow,
...
export const semrushSubdomainOverviewHistoryTool: ToolConfig<
  SemrushSubdomainOverviewHistoryParams,
  SemrushSubdomainOverviewHistoryResponse
> = {
  id: 'semrush_subdomain_overview_history',
  name: 'Semrush Subdomain Overview History',
  ...
  transformResponse: async (response: Response) => {
    const rows = await readSemrushReport<SemrushSubdomainOverviewHistoryRow>(response, COLUMNS)
