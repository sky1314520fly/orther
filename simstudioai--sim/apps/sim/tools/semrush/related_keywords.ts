import type {
  SemrushRelatedKeywordsParams,
  SemrushRelatedKeywordsResponse,
  SemrushRelatedKeywordsRow,
...
const COLUMNS = ['Ph', 'Nq', 'Cp', 'Co', 'Nr', 'Kd', 'Rr', 'Fk', 'In', 'Td'] as const

export const semrushRelatedKeywordsTool: ToolConfig<
  SemrushRelatedKeywordsParams,
  SemrushRelatedKeywordsResponse
> = {
  id: 'semrush_related_keywords',
  name: 'Semrush Related Keywords',
  description:
  ...
  transformResponse: async (response: Response) => {
    const rows = await readSemrushReport<SemrushRelatedKeywordsRow>(response, COLUMNS)
    ...
    keywords: {
      ...
      items: {
        ...
        properties: {
          ...
          relatedRelevance: {
            type: 'number',
            description: 'Relevance of the result keyword to the seed keyword',
            optional: true,
            nullable: true,
          },
          keywordSerpFeatures: {
