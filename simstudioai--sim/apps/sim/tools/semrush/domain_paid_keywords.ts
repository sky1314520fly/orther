import type {
  SemrushDomainPaidKeywordsParams,
  SemrushDomainPaidKeywordsResponse,
  SemrushDomainPaidKeywordsRow,
...
export const semrushDomainPaidKeywordsTool: ToolConfig<
  SemrushDomainPaidKeywordsParams,
  SemrushDomainPaidKeywordsResponse
> = {
  id: 'semrush_domain_paid_keywords',
  name: 'Semrush Domain Paid Keywords',
  description:
  ...
  transformResponse: async (response: Response) => {
    const rows = await readSemrushReport<SemrushDomainPaidKeywordsRow>(response, COLUMNS)
  ...
  outputs: {
    keywords: {
      type: 'array',
      description: 'Paid keywords the domain bids on',
      items: {
        type: 'object',
        properties: {
          keyword: {
