...
export const gmailUnarchiveTool: InternalToolConfig<GmailMarkReadParams, GmailToolResponse> = {
  id: 'gmail_unarchive',
...
export const gmailUnarchiveV2Tool: InternalToolConfig<GmailMarkReadParams, GmailModifyV2Response> =
  {
    ...
    operation: gmailUnarchiveTool.operation,
    transformResponse: async (response) => {
