import type { ListInboundDeliveriesParams, SapS4HanaResponse } from '@/tools/sap_s4hana/types'
import { buildOdataQuery, buildSapOperationBaseInput } from '@/tools/sap_s4hana/utils'
import type { InternalToolConfig } from '@/tools/types'

export const listInboundDeliveriesTool: InternalToolConfig<
  ListInboundDeliveriesParams,
  SapS4HanaResponse
> = {
