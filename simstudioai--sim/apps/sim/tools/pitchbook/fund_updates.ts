...
export const pitchbookFundUpdatesTool: ToolConfig<PitchbookUpdatesParams, PitchbookResponse> = {
  id: 'pitchbook_fund_updates',
  ...
  request: {
    url: (params) => {
      ...
      return `${PITCHBOOK_API_BASE}/funds/${params.pbId.trim()}/updates${query ? `?${query}` : ''}`
    },
    method: 'GET',
