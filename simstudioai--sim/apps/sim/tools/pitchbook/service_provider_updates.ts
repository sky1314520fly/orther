...
export const pitchbookServiceProviderUpdatesTool: ToolConfig<
  PitchbookUpdatesParams,
  PitchbookResponse
> = {
  id: 'pitchbook_service_provider_updates',
  name: 'PitchBook Service Provider Updates',
  description:
  ...
  request: {
    url: (params) => {
      ...
      return `${PITCHBOOK_API_BASE}/service-providers/${params.pbId.trim()}/updates${query ? `?${query}` : ''}`
    },
    method: 'GET',
