...
export const pitchbookDealDetailedTool: ToolConfig<PitchbookProfileParams, PitchbookResponse> = {
  id: 'pitchbook_deal_detailed',
  name: 'PitchBook Deal Detailed',
  description:
  ...
  request: {
    url: (params) => `${PITCHBOOK_API_BASE}/deals/${params.pbId.trim()}/detailed`,
    method: 'GET',
    headers: (params) => pitchbookAuthHeaders(params.apiKey, params.currency),
  },

  transformResponse: async (response: Response) => {
    await throwIfNotOk(response, 'Failed to fetch deal detail')
    ...
    return {
      ...
      output: {
        ...
        percentAcquired: data.percentAcquired ?? null,
        raisedToDate: data.raisedToDate ?? null,
        vcRound: data.vcRound ?? null,
        vcRoundUpDownFlat: data.vcRoundUpDownFlat ?? null,
        totalInvestedCapital: data.totalInvestedCapital ?? null,
        investorOwnership: data.investorOwnership ?? null,
        stockSplit: data.stockSplit ?? null,
        dealType1: data.dealType1 ?? null,
        dealType2: data.dealType2 ?? null,
        dealType3: data.dealType3 ?? null,
        dealClass: data.dealClass ?? null,
        dealSynopsis: data.dealSynopsis ?? null,
        totalInvestedEquity: data.totalInvestedEquity ?? null,
        debtType1: data.debtType1 ?? null,
        debtType2: data.debtType2 ?? null,
        debtType3: data.debtType3 ?? null,
        debtAmount1: data.debtAmount1 ?? null,
        debtAmount2: data.debtAmount2 ?? null,
        debtAmount3: data.debtAmount3 ?? null,
        debtRaisedInRound: data.debtRaisedInRound ?? null,
        contingentPayout: data.contingentPayout ?? null,
  ...
  outputs: {
    ...
    percentAcquired: {
      type: 'number',
      description: 'Percentage of the company acquired in the deal',
      nullable: true,
    },
    raisedToDate: {
      type: 'object',
      description: 'Total the company had raised as of this deal',
      nullable: true,
      properties: {
        amount: { type: 'number', description: 'Value in the requested currency', nullable: true },
        currency: { type: 'string', description: 'Currency of amount', nullable: true },
    ...
    vcRound: {
      type: 'string',
      description: 'Venture round label, such as 1st Round',
      nullable: true,
    },
    vcRoundUpDownFlat: {
      type: 'string',
      description: 'Whether the round was up, down, or flat versus the previous one',
      nullable: true,
    },
    totalInvestedCapital: {
      type: 'object',
      description: 'Total capital invested in the deal',
      nullable: true,
      properties: {
        amount: { type: 'number', description: 'Value in the requested currency', nullable: true },
        currency: { type: 'string', description: 'Currency of amount', nullable: true },
    ...
    investorOwnership: {
      type: 'number',
      description: 'Percentage of the company owned by investors after the deal',
      nullable: true,
    },
    stockSplit: {
      type: 'string',
      description: 'Stock split applied at the deal, such as 1:1',
      nullable: true,
    },
    dealType1: {
      type: 'object',
    ...
    dealSynopsis: { type: 'string', description: 'Narrative summary of the deal', nullable: true },
    totalInvestedEquity: {
      type: 'object',
      description: 'Total equity invested in the deal',
      nullable: true,
      properties: {
        amount: { type: 'number', description: 'Value in the requested currency', nullable: true },
        currency: { type: 'string', description: 'Currency of amount', nullable: true },
    ...
    debtType1: {
      type: 'object',
      description: 'Primary debt type raised in the deal',
      nullable: true,
      properties: {
        code: { type: 'string', description: 'PitchBook code', nullable: true },
        description: {
    ...
    debtType2: {
      type: 'object',
      description: 'Secondary debt type raised in the deal',
      nullable: true,
      properties: {
        code: { type: 'string', description: 'PitchBook code', nullable: true },
        description: {
    ...
    debtType3: {
      type: 'object',
      description: 'Tertiary debt type raised in the deal',
      nullable: true,
      properties: {
        code: { type: 'string', description: 'PitchBook code', nullable: true },
        description: {
    ...
    debtAmount1: {
      type: 'object',
      description: 'Amount of the primary debt type',
      nullable: true,
      properties: {
        amount: { type: 'number', description: 'Value in the requested currency', nullable: true },
        currency: { type: 'string', description: 'Currency of amount', nullable: true },
    ...
    debtAmount2: {
      type: 'object',
      description: 'Amount of the secondary debt type',
      nullable: true,
      properties: {
        amount: { type: 'number', description: 'Value in the requested currency', nullable: true },
        currency: { type: 'string', description: 'Currency of amount', nullable: true },
    ...
    debtAmount3: {
      type: 'object',
      description: 'Amount of the tertiary debt type',
      nullable: true,
      properties: {
        amount: { type: 'number', description: 'Value in the requested currency', nullable: true },
        currency: { type: 'string', description: 'Currency of amount', nullable: true },
    ...
    debtRaisedInRound: {
      type: 'object',
      description: 'Total debt raised in the round',
      nullable: true,
      properties: {
        amount: { type: 'number', description: 'Value in the requested currency', nullable: true },
        currency: { type: 'string', description: 'Currency of amount', nullable: true },
    ...
    contingentPayout: {
      type: 'object',
      description: 'Contingent payout attached to the deal',
      nullable: true,
      properties: {
        amount: { type: 'number', description: 'Value in the requested currency', nullable: true },
        currency: { type: 'string', description: 'Currency of amount', nullable: true },
