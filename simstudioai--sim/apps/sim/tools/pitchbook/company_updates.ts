...
export const pitchbookCompanyUpdatesTool: ToolConfig<PitchbookUpdatesParams, PitchbookResponse> = {
  id: 'pitchbook_company_updates',
  name: 'PitchBook Company Updates',
  description:
  ...
  request: {
    url: (params) => {
      ...
      return `${PITCHBOOK_API_BASE}/companies/${params.pbId.trim()}/updates${query ? `?${query}` : ''}`
    },
    method: 'GET',
