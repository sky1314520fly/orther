...
export const pitchbookInvestorUpdatesTool: ToolConfig<PitchbookUpdatesParams, PitchbookResponse> = {
  id: 'pitchbook_investor_updates',
  name: 'PitchBook Investor Updates',
  description:
  ...
  request: {
    url: (params) => {
      ...
      return `${PITCHBOOK_API_BASE}/investors/${params.pbId.trim()}/updates${query ? `?${query}` : ''}`
    },
    method: 'GET',
