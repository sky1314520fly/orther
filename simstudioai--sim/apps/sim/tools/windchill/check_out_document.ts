...
export const windchillCheckOutDocumentTool: InternalToolConfig<WindchillParams, WindchillResponse> =
  {
    ...
    operation: {
      input: (params) => buildWindchillInternalBody('windchill_check_out_document', params),
    },
