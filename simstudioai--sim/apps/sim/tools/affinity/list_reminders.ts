...
export const affinityListRemindersTool: ToolConfig<
  AffinityListRemindersParams,
  AffinityCollectionResponse<'reminders'>
> = {
  id: 'affinity_list_reminders',
  name: 'Affinity List Reminders',
  description:
  ...
  transformResponse: transformCollection('reminders'),

  outputs: {
    reminders: {
      type: 'array',
      description: 'Reminders visible to the caller',
      items: { type: 'object', properties: REMINDER_OUTPUT_PROPERTIES },
    },
