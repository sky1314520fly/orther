...
export const affinitySearchCompaniesTool: ToolConfig<
  AffinitySearchEntitiesParams,
  AffinityCollectionResponse<'companies'>
> = {
  id: 'affinity_search_companies',
  name: 'Affinity Search Companies',
  description:
  ...
  request: {
    url: (params) =>
      buildAffinityUrl('/companies/search', {
  ...
  outputs: {
    companies: {
      type: 'array',
      description: 'Matching companies with any requested field values',
