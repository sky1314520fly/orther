...
export const affinityListInvestorExecutiveConnectionsTool: ToolConfig<
  AffinityListInferredConnectionsParams,
  AffinityCollectionResponse<'connections'>
> = {
  id: 'affinity_list_investor_executive_connections',
  name: 'Affinity List Investor Executive Connections',
  description:
  ...
  request: {
    url: (params) =>
      buildAffinityUrl('/inferred-connections/investor-executive-connections', {
  ...
  outputs: {
    connections: {
      type: 'array',
      description: 'Targets and the investors who might introduce you',
