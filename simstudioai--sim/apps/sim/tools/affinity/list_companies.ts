...
export const affinityListCompaniesTool: ToolConfig<
  AffinityListCompaniesParams,
  AffinityCollectionResponse<'companies'>
> = {
  id: 'affinity_list_companies',
  name: 'Affinity List Companies',
  description:
  ...
  params: {
    ...
    ids: {
      ...
      description: 'Restrict the page to these company IDs, e.g. [1, 2, 3]',
    },
    fieldIds: {
      type: 'json',
      required: false,
  ...
  outputs: {
    companies: {
      type: 'array',
      description: 'Companies with any requested field values',
