...
import { googleSlidesConnector } from '@/connectors/google-slides'
import { googleVaultConnector } from '@/connectors/google-vault'
...
import { microsoftExcelConnector } from '@/connectors/microsoft-excel'
import { microsoftTeamsConnector } from '@/connectors/microsoft-teams'
import { mintlifyConnector } from '@/connectors/mintlify'
...
import { sftpConnector } from '@/connectors/sftp'
...
import { zohoDeskConnector } from '@/connectors/zoho-desk'
...
export const CONNECTOR_REGISTRY: ConnectorRegistry = {
  ...
  google_slides: googleSlidesConnector,
  google_vault: googleVaultConnector,
  ...
  microsoft_excel: microsoftExcelConnector,
  microsoft_teams: microsoftTeamsConnector,
  mintlify: mintlifyConnector,
