// Live-surface driver for #6131: drives the production lsp MCP stdio server
// (packages/lsp-tools-mcp/src/cli.ts) against REAL marksman in an isolated
// workspace + isolated user LSP config, and records lsp_diagnostics on a clean README.md.
// Usage: bun /tmp/ulw-6131-live-driver.mts <repoRoot> <marksmanExe>
...
if (!repoRoot || !marksmanExe) {
	console.error("usage: bun live-driver.mts <repoRoot> <marksmanExe>");
	process.exit(2);
}
