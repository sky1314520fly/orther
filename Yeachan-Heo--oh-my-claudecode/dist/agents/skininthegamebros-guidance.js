...
const SKININTHEGAMEBROS_GUIDANCE_HEADER = {
...
export function renderSkininthegamebrosGuidance(surface) {
    if (!isSkininthegamebrosUser()) {
        return '';
    }
    return [SKININTHEGAMEBROS_GUIDANCE_HEADER[surface], ...SKININTHEGAMEBROS_GUIDANCE_LINES].join('\n');
}
export function appendSkininthegamebrosGuidance(basePrompt, surface) {
...
//# sourceMappingURL=skininthegamebros-guidance.js.map