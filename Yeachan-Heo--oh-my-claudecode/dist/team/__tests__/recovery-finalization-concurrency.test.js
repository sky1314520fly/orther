...
describe('recovery terminal publication revision fence', () => {
    it('publishes no final when a competing normal config writer wins after the recovery snapshot', async () => {
        ...
        const result = {
            outcome: 'already_running', committed: true, oldPaneId: '%1', newPaneId: '%1',
        ...
        const finalized = await finalizeRecoveryOwnerResult({ teamName, cwd, workerName: 'worker-1', requestId: 'request-a' }, 'recovery-a', result, {
...
//# sourceMappingURL=recovery-finalization-concurrency.test.js.map