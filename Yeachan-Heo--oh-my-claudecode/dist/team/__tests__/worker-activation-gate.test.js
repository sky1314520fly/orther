...
async function acceptedAttempt(workerName, paneId, recoveryId, generation, paneAttemptId) {
...
describe('worker recovery activation gate', () => {
    ...
    ])('rejects recovery markers when only %s differs', async (field, replacement) => {
