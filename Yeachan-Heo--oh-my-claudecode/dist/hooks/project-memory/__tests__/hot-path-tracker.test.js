...
function hotPath(path, accessCount) {
...
describe("getTopHotPaths scope affinity", () => {
    ...
    it("ranks identically whether the in-scope path uses POSIX or Windows separators", () => {
        const posix = getTopHotPaths([hotPath("docs/guide.md", 5), hotPath("src/app/index.ts", 3)], 10, { workingDirectory: "src/app", now: NOW });
        const windows = getTopHotPaths([hotPath("docs\\guide.md", 5), hotPath("src\\app\\index.ts", 3)], 10, { workingDirectory: "src/app", now: NOW });
...
//# sourceMappingURL=hot-path-tracker.test.js.map