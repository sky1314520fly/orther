...
async function readIssueCooldownKeys() {
    try {
...
async function drain(injector) {
    return drainPendingTeamDispatch({
        cwd: root,
        stateDir,
        logsDir,
        maxPerTick: 10,
        injector: async (request) => injector(request),
    });
}
beforeEach(async () => {
...
//# sourceMappingURL=team-dispatch-cooldown.test.js.map