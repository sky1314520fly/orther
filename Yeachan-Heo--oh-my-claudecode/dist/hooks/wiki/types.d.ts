...
export declare const WIKI_SCHEMA_VERSION = 1;
...
export type WikiLintIssueType = 'orphan' | 'stale' | 'broken-ref' | 'low-confidence' | 'oversized' | 'structural-contradiction';
/** A single lint issue. */
...
export declare const DEFAULT_WIKI_CONFIG: WikiConfig;
