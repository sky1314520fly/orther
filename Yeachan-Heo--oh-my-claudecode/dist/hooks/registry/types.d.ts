...
export declare const HOOK_EVENTS: readonly ["UserPromptSubmit", "SessionStart", "PreToolUse", "PermissionRequest", "PostToolUse", "PostToolUseFailure", "SubagentStart", "SubagentStop", "PreCompact", "Stop", "SessionEnd"];
...
export type HookHandler = (input: unknown) => Promise<Record<string, unknown>> | Record<string, unknown>;
export type ShadowVerdict = 'equivalent' | 'divergent' | 'deferred' | 'unmapped';
/**
