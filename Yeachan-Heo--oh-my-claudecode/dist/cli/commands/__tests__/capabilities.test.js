...
import { buildCapabilitiesLockfile, capabilitiesCheckCommand, capabilitiesLockCommand, runDeterministicCapabilityFixtures, skillNameFromSkillFilePath, } from '../capabilities.js';
...
describe('capabilities lock/check', () => {
    ...
    it('writes a deterministic lockfile and checks it successfully', async () => {
        await withTempCwd(async (cwd) => {
            ...
            const written = JSON.parse(await readFile(lockfile, 'utf-8'));
