...
import { analyzeLegacyClaudeMd, getLegacyGuideManifestForVerification, parseClaudeMdMarkers, removeClaudeMdRanges, } from '../claude-md-analysis.js';
...
describe('legacy CLAUDE.md corpus', () => {
    it('independently verifies all reviewed bytes and one-way runtime signatures', () => {
        ...
        const variants = corpus.variants;
...
describe('CLAUDE.md structural analysis', () => {
    ...
    it('does not join legacy-guide fragments across a managed block before analysis', () => {
        const guide = Buffer.from(corpus.variants[0].dataBase64, 'base64').toString('utf8');
    ...
    it('matches only exact historical content and retains user EOL bytes', () => {
        const golden = corpus.variants[0];
...
//# sourceMappingURL=claude-md-analysis.test.js.map