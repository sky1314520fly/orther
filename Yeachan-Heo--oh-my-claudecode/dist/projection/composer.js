...
function extractCanonicalBody(canonicalDocsRaw) {
    ...
    if (startEol === -1)
        throw new Error('malformed start marker');
 ...
 */
export function composeManagedBlock(input) {
 ...
 */
export function canonicalSourceRevision(canonicalDocsRaw) {
...
export function composeAllClaudeProjections(input) {
