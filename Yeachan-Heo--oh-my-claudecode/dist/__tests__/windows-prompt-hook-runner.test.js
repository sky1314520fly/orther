...
function makePlugin(root, source, timeout = 10) {
...
function run(target, root, env = {}, args = []) {
...
function runDelayedPromptRunner(root, target) {
    const launcher = `
...
//# sourceMappingURL=windows-prompt-hook-runner.test.js.map