...
export default {
  ...
  "context_panel.effective_permissions": "How agents run here",
  "context_panel.effective_permissions_desc": "What the engine will do in this workspace before asking you, and which config decided it. Read from the engine itself.",
  "context_panel.effective_permissions_agent": "Agent: {agent}",
  "context_panel.effective_permissions_loading": "Reading the engine's permission rules...",
  "context_panel.effective_permissions_unavailable": "Connect to an OpenWork server workspace with a running engine to see how agents run here.",
  "context_panel.effective_permissions_exceptions": "{count} narrower rules",
  "context_panel.effective_permission_shell": "Shell commands",
  "context_panel.effective_permission_edit": "File edits",
  "context_panel.effective_permission_web": "Web fetches",
  "context_panel.effective_permission_mcp": "MCP tools",
  "context_panel.effective_permission_outside_folders": "Files outside authorized folders",
  "context_panel.effective_permission_env_files": ".env files",
  "context_panel.effective_permission_doom_loop": "Repeating an identical call",
  "context_panel.permission_action_allow": "Runs",
  "context_panel.permission_action_ask": "Asks you",
  "context_panel.permission_action_deny": "Blocked",
  "context_panel.permission_source_engine": "Engine default",
  "context_panel.permission_source_global": "Your global opencode.json",
  "context_panel.permission_source_openwork": "OpenWork",
  "context_panel.permission_source_workspace": "This workspace's opencode.json",
  ...
  "extensions.add_mcp": "Add organization MCP",
  "extensions.add_workspace_mcp": "Add workspace MCP",
  "extensions.add_plugin": "Add plugin",
  "extensions.add_connection": "Add connection",
  "extensions.add_picker_title": "Add to your Library",
  "extensions.add_picker_hint": "Create something in OpenWork, add an MCP server by URL, or manage a hosted service connection in Den.",
  "extensions.add_picker_make": "WHAT ARE YOU MAKING",
  "extensions.add_picker_connect": "OR CONNECT SOMETHING",
  "extensions.add_picker_footer": "Choose access during creation. Hosted connections continue in Den.",
  ...
  "extensions.kind_connection_badge": "Opens Den",
  ...
  "extensions.add_mcp_connection_hint": "Say how it authenticates, the same way you would under Connectors, and it is ready as soon as it is saved.",
  "extensions.add_mcp_auth_label": "Authentication",
  "extensions.add_mcp_auth_oauth": "OAuth",
  "extensions.add_mcp_auth_apikey": "API key",
  "extensions.add_mcp_auth_none": "None",
  "extensions.add_mcp_api_key_label": "API key",
  "extensions.add_mcp_api_key_hint": "Stored encrypted as one organization credential.",
  "extensions.add_mcp_api_key_required": "Enter the API key for the MCP server.",
  "extensions.add_mcp_account_label": "Whose account does the AI use?",
  "extensions.add_mcp_account_per_member": "Individual accounts",
  "extensions.add_mcp_account_per_member_hint": "Each person signs in with their own account from Your Connections. Their AI acts as them, with their permissions.",
  "extensions.add_mcp_account_shared": "One org account",
  "extensions.add_mcp_account_shared_hint": "You sign in once with a single account — everyone granted access acts as it. Good for bot or service accounts.",
  "extensions.add_mcp_oauth_app_toggle": "Use a pre-registered OAuth app instead",
  "extensions.add_mcp_oauth_app_hint": "Register this Den instance's redirect URL with the provider, then add its credentials here.",
  "extensions.add_mcp_oauth_client_id_label": "Client ID (optional for now)",
  "extensions.add_mcp_oauth_client_secret_label": "Client secret (optional for now)",
  ...
  "session.engine_reload_action": "Reload engine",
  ...
  "session.permission_requested_by": "Requested by {session}",
